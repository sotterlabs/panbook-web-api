@if( count($ventas) == 0)
	<h3 class="blue-text text-darken-4 center">No hay registro de ventas para el mes seleccionado</h3>

@else
	<br><br>
	<div>
		<h3 class="blue-text text-darken-4 center">Resumen del mes seleccionado</h3>
	</div>
	<div class="col s12">
		<table class="striped">
			<thead>
